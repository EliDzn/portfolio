...
export default function Hero() {
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 grid grid-cols-4 gap-(--spacing-grid-mobile) md:grid-cols-8 md:gap-(--spacing-grid-tablet) lg:grid-cols-12 lg:gap-(--spacing-grid-desktop)">
      ...
      <div className="col-span-full row-start-2 mb-8 grid grid-cols-subgrid items-end">
        <div className="col-span-4 lg:col-span-8">
          ...
          <Text variant="body-lg" className="text-muted-foreground">
            I curate user-centered, minimalist interfaces with a desktop-first
            design that feels alive, where every micro-interaction makes the
            experience both visually refined and functional.
          </Text>
        </div>
